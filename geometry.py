...
module_logger = logging.getLogger('HADES.geometry')
...
class image(object):
    ...
    def __init__(self,input_par):
        ...
        self.logger = logging.getLogger('HADES.geometry.image')
        self.logger.info('Creating an instance of image')
    ...
    def print_to_file(self):
            self.logger.info('Requested print value table to file '+self.out_file+'.')
            ...
            outfile.write ("-----End Size map properties----"+'\n')


            self.logger.info('Value table correctly written to file '+self.out_file+'.')
    ...
    def print_to_screen(self):
            ...
            stype('Pixels in the map: '+str( np.round(self.y_max-self.y_min))+' x '+ str( np.round(
                self.z_max-self.z_min))+'  (horizontal x vertical)')
            stype('Size of pixels in mas: '+str(self.cell_area)+'\n')
...
def tracer_limits(tracer,limit):
        ...
        logger = logging.getLogger('HADES.geometry.tracer_limits')
        logger.info('Requested a calculation of jet limits along the z axis')
